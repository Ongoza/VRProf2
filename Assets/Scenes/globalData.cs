...
//	private static string urlDataServer = "http://192.168.1.64:27080/local/vrprof";
	...
	public static void addcTest(List<int> value) {		
		if (trColorTest1 == 0) {colorTest1.AddRange (value); trColorTest1++;
	...
	public static bool setCurrentTutorial(string name) {bool sel=false;
...
[System.Serializable] public class CurDataAnswer{
