...
public class Main : MonoBehaviour
{
    ...
    private void showMainMenu()
    {
        ...
        NewCanvasRect.localScale = new Vector3(0.1f, 0.1f, 1f);
        NewCanvasRect.localPosition = new Vector3(0, 10, -10);
        ...
        panelTransform.localPosition = new Vector3(0, 6, 0);
        panelTransform.sizeDelta = new Vector2(1200, 300);
        //panelTransform.rotation = Quaternion.AngleAxis(-180, Vector3.up);

        CreateText(panelTransform, 0, 16, 1200, 180, msg, 50, 0, TextAnchor.MiddleCenter);
    ...
    void showProgressBar()
    {
        ...
        if (!globalData.getTrReadyVideo())
        {
            GameObject canvasProgressBar = new GameObject("CnvsProgress");
    ...
    private void showTutorialsMenu(GameObject rootMenu)
    {
        ...
        NewCanvasRect.localScale = new Vector3(0.1f, 0.1f, 1f);
        NewCanvasRect.localPosition = new Vector3(0, -2, -10);
        ...
        createMovieButton("btnModel", 60, 30, tex1, mainTransform, mat, true);
        Texture2D tex2 = (Texture2D)Resources.Load("Textures/dayCoach");
        createMovieButton("btnCach", -60, 30, tex2, mainTransform, mat, false);
        Texture2D tex3 = (Texture2D)Resources.Load("Textures/dayDeveloper");
        createMovieButton("btnDeveloper", 60, -30, tex3, mainTransform, mat, false);
        Texture2D tex4 = (Texture2D)Resources.Load("Textures/daySales");
        createMovieButton("btnSales", -60, -30, tex4, mainTransform, mat, false);
    ...
    private void showTutorialContent(string name)
    {
        ...
        createItemButton("Part_1", 80, 0, tex1, mainTransform, mat, true, "Part 1\nThe first meeting");
        Texture2D tex2 = (Texture2D)Resources.Load("Textures/Part_2");
        createItemButton("Part_2", 0, 0, tex2, mainTransform, mat, true, "Part 2\nThe photo session");
        Texture2D tex3 = (Texture2D)Resources.Load("Textures/part_1");
        createItemButton("Part_3", -80, 0, tex3, mainTransform, mat, true, "Part 3\nInformation\nabout a carrier");

    }
    private void createItemButton(string name, float x, float y, Texture2D tex, RectTransform root, Material mat, bool active, string Description)
    {
